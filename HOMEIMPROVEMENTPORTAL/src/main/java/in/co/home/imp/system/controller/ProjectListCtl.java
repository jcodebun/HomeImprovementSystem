...
/**
 * Servlet implementation class ProjectListCtl
 */
...
public class ProjectListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("ProjectListCtl populateBean method start");
		...
		log.debug("ProjectListCtl populateBean method end");
		return bean;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("ProjectListCtl doGet method start");
		List list = null;
		int pageNo = 1;
		...
		log.debug("ProjectListCtl doGet method end");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("ProjectListCtl doPost method start");
		List list = null;
		...
		log.debug("ProjectListCtl doPost method end");
	}

	@Override
	protected String getView() {
		// TODO Auto-generated method stub
		return HISView.PROJECT_LIST_VIEW;
	}
