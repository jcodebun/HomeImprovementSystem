<%@page import="in.co.home.imp.system.model.ApplicationModel"%>
<%@page import="in.co.home.imp.system.util.DataUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="in.co.home.imp.system.bean.ApplicationBean"%>
<%@page import="in.co.home.imp.system.controller.ApplicationListCtl"%>
...
<form action="<%=HISView.APPLICATION_LIST_CTL%>" method="post">			
        ...
        <div class="row ">
                    <div class="form-row">
                        ...
                        <label>Application Name</label>
                          <input type="text" class="form-control" name="name" id="inputEmail4" placeholder="Application Name"
                          value="<%=ServletUtility.getParameter("name", request)%>">
                        </div>
                        
                         <div class="form-group col-md-4">
                        
                          <input type="submit" name="operation" value="<%=ApplicationListCtl.OP_SEARCH%>" class="btn btn-danger" style="margin-top: 30px">
                        </div>
                      </div>
            </div>
        </div>
...
<table>
  ...
  <tbody id="myTable">
  				<%
					...
					Iterator<ApplicationBean> iterator = list.iterator();
				...
				%>
    					...
    					<td align="center"><%=index++%></td>
      						...
      						<td><%=DataUtility.getTimestamp(bean.getDate())%></td>
      						<td><%=bean.getResidentDetail()%></td>
      						<td><%=bean.getWorkDescription()%></td>
  						 </tr>
   					<%} %>
  </tbody>
</table>
