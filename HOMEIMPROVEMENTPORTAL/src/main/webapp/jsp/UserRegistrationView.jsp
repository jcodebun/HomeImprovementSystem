<%@page import="in.co.home.imp.system.controller.UserRegistrationCtl"%>
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-md-8 py-5 border">
                ...
                <form method="post" action="<%=HISView.USER_REGISTRATION_CTL%>">
				...
				value="<%=DataUtility.getTimestamp(bean.getModifiedDatetime())%>">
                  ...
                  <div class="form-row">
                   ...
                   <div class="form-row">
                    ...
                    <div class="form-row">
                        <input type="submit" class="btn btn-danger" name="operation" value="<%=UserRegistrationCtl.OP_SIGN_UP%>">
                        &nbsp;&nbsp;&nbsp;
                        <input type="submit" class="btn btn-danger" name="operation" value="<%=UserRegistrationCtl.OP_RESET%>">
                    </div>
                </form>
            </div>
        </div>
